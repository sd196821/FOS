...
*
*      深圳市凯瑞莱科技开发提供的所有ST、TI、Freescale、Altera等平台的例程、文档、方案等资料信息旨在为学习者提供学习参考，若使用者在使用过程中因任何原因造成直接或间接的损失，深圳市凯瑞莱科技开发不承担任何责任。
*  
*
*
*                                                                             深圳市凯瑞莱科技开发*
...
*--------------------------------------------------------------------------------------------------------
* Function:          led_init
* Description:       ST-M3-LITE-407ZE精简开发板有1个引脚连接了LED发光二极管，
...
# if 1    /* IO 测试   */
    ...
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA |
                           ...
                           RCC_AHB1Periph_GPIOG, ENABLE);    /* 使能端口时钟                                     */  	 
